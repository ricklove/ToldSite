...
(function (Told) {
    (function (Analytics) {
        Analytics.GoogleAnalyticsTrackingID = "UA-51336565-4";
        ...
        var GoogleAnalyticsMeasurementProtocol = (function () {
            ...
            GoogleAnalyticsMeasurementProtocol.trackPageView = function () {
                var guaTrackingID = Analytics.GoogleAnalyticsTrackingID;
                ...
                //xhr.send(d.toString());
                GoogleAnalyticsMeasurementProtocol.hasSentPageView = true;
            };
